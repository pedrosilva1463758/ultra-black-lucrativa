...
${group ? `<p>O link da live eu vou mandar no grupo do WhatsApp. Se você ainda não entrou, entra por aqui:</p>
<p style="margin:0 0 18px 0;"><a href="${group}" style="display:inline-block;background:#25D366;color:#ffffff;font-weight:bold;text-decoration:none;padding:12px 22px;border-radius:24px;">Entrar no grupo do WhatsApp</a></p>` : ""}
